...
const CountryLayout: React.FC = () => {
  ...
  const countries: Country[] = [
    ...
    { name: "Portugal", language: "Português", flag: "https://flagcdn.com/pt.svg", code: "pt" },
    { name: "China", language: "中文", flag: "https://flagcdn.com/cn.svg", code: "cn" },
    { name: "Hong Kong", language: "中文", flag: "https://flagcdn.com/hk.svg", code: "hk" },
    ...
    { name: "Chile", language: "español", flag: "https://flagcdn.com/cl.svg", code: "cl" },
    { name: "Colombia", language: "español", flag: "https://flagcdn.com/co.svg", code: "co" },
    { name: "European Union", language: "français", flag: "https://flagcdn.com/eu.svg", code: "eu" },
    ...
    { name: "Ukraine", language: "Pусский", flag: "https://flagcdn.com/ua.svg", code: "ua" },
    { name: "South Africa", language: "isiZulu", flag: "https://flagcdn.com/za.svg", code: "za" },
  ];
